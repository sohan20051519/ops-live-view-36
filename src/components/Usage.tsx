    ...
    <div className="h-full p-6 space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex-1 min-w-0">
          <h1 className="text-2xl sm:text-3xl font-bold mb-2">Resource Usage & Costs</h1>
          <p className="text-muted-foreground text-sm sm:text-base leading-relaxed">Monitor your infrastructure usage and optimize costs</p>
        </div>
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:gap-3 sm:flex-shrink-0">
          <Button variant="outline" size="sm" className="w-full sm:w-auto whitespace-nowrap">
            <Download className="w-4 h-4 mr-2" />
            Export Report
          </Button>
          <Badge variant="outline" className="px-3 py-2 justify-center sm:justify-start whitespace-nowrap">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-3">
            <div className="flex flex-col sm:flex-row sm:items-start gap-3 p-3 bg-blue-50 dark:bg-blue-950/20 rounded-lg border border-blue-200 dark:border-blue-800">
              ...
              <Button size="sm" variant="outline" className="border-blue-300 w-full sm:w-auto flex-shrink-0">
                Apply
              </Button>
            </div>
            
            <div className="flex flex-col sm:flex-row sm:items-start gap-3 p-3 bg-green-50 dark:bg-green-950/20 rounded-lg border border-green-200 dark:border-green-800">
              ...
              <Button size="sm" variant="outline" className="border-green-300 w-full sm:w-auto flex-shrink-0">
                Configure
              </Button>
            </div>
            
            <div className="flex flex-col sm:flex-row sm:items-start gap-3 p-3 bg-yellow-50 dark:bg-yellow-950/20 rounded-lg border border-yellow-200 dark:border-yellow-800">
              ...
              <Button size="sm" variant="outline" className="border-yellow-300 w-full sm:w-auto flex-shrink-0">
                Clean Up
              </Button>
            </div>
          </div>

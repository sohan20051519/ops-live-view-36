              ...
              <div className="space-y-2 pt-2">
                ...
                <div className="flex gap-2">
                  <Button variant="outline" size="sm" className="flex-1 text-xs">
                    ...
                    <span className="hidden sm:inline">{project.domain ? "Manage Domain" : "Add Domain"}</span>
                    <span className="sm:hidden">Domain</span>
                  </Button>
                  <Button variant="outline" size="sm" className="text-destructive hover:text-destructive-foreground hover:bg-destructive px-2">
